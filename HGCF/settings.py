...
# aws settings
AWS_ACCESS_KEY_ID = 'AKIAXJ7ZGRRYB2XZUD54' #os.environ.get('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = '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' #os.environ.get('AWS_SECRET_ACCESS_KEY')
